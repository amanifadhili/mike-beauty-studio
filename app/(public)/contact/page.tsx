...
export default async function ContactPage() {
  ...
  return (
    <div className="bg-charcoal min-h-[calc(100vh-80px)] pt-20 pb-12 text-cream-white relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <SectionHeading 
            ...
            alignment="center"
            className="text-white [&>h2]:text-white [&>span]:text-gold [&>h2]:text-3xl md:[&>h2]:text-4xl [&>p]:text-sm md:[&>p]:text-base mb-0"
          />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 max-w-6xl mx-auto">
          ...
          <div className="flex flex-col justify-between space-y-6 md:space-y-8 bg-[#1a1a1a] p-6 md:p-8 border border-white/5">
            
            <div>
              <h3 className="font-playfair text-xl text-gold mb-3">Studio Location</h3>
              <div className="font-sans text-gray-300 space-y-1 text-sm leading-relaxed whitespace-pre-line">
            ...
            <div>
              ...
              <div className="font-sans space-y-3">
                ...
                >
                  <div className="w-8 h-8 border border-white/20 group-hover:border-gold flex items-center justify-center rounded-full transition-colors">
            ...
            <div>
              ...
              <ul className="font-sans text-gray-300 text-sm space-y-2">
          ...
          <div className="h-[300px] lg:h-auto min-h-[300px] border border-white/5 relative overflow-hidden">
            <MapWrapper />
          </div>
